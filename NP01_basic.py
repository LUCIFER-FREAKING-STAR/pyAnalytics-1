...
x3.shape
x4 = np.random.randint(20,size=(2,4,3)); x4
##size(number of matrices,number of rows,number of colums)
x4.shape
X5= np.random.randint([1,2,3],4)
X5
x6=np.random.randint(4,[10,12,14])
x6
x7=np.random.randint([12,13,14],[[19],[30]])
x7
x7.shape
...
x2[1,-2] ##second row and second element from left
x2[0,-2]
x2[0,-3]
x2
